    ...
    public static void main(String[] args) {
        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                if (!sc.hasNextInt()) {
                    System.out.println("Invalid input. Stopping event entry.");
                    break;
                }
                ...
                if (!sc.hasNextLine()) {
                    System.out.println("Missing title input. Stopping event entry.");
                    break;
                }
                ...
                if (!sc.hasNextLine()) {
                    System.out.println("Missing date input. Stopping event entry.");
                    break;
                }
                ...
                if (!sc.hasNextLine()) {
                    System.out.println("Missing time input. Stopping event entry.");
                    break;
                }
